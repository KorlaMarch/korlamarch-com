...
export const IndexPageTemplate = ({
  ...
  <section className="section" style={{
    ...
    <div className="container">
      <h1 className="title is-1 has-text-centered is-uppercase" style={{
  ...
  <nav className="level">
    ...
    <Link to="/cv.pdf" className="level-item">
      CV
    </Link>
  </nav>
  <p>
  ...
  <section className="section">
      <h3 className="title is-3">My work</h3>
      <ul style={{
        ...
        <li>
          ENGN 520: Electronic and Circuit TA
        </li>
      </ul> 
  </section>
  </div>
